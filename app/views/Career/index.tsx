    ...
    <div className="career-page">
            ...
            <Col className="flex-30">
              <Card className="border-0 p-4 h-100 border-rounded">
                <Card.Body className="p-0">
                  ...
                  <Card.Text>
                    Whether you’re just starting out or looking to take the next
                    big step, we provide ample opportunities for learning and
                    career advancement. We believe in promoting from within and
                    recognizing potential at every level.
                  </Card.Text>
                </Card.Body>
              </Card>
            </Col>
      ...
      <section className="padding-y-100 bg-light-blue">
        <Container className="bg-white max-width-75 rounded-4">
          ...
          <h3 className="text-center cambria-bold">Submit Your Application</h3>
        ...
        >
          <div className="">
            ...
            <p className="lead mt-3">
              ...
              the next level, GP Agarwal Group offers the platform, mentoring,
              and vision to thrive. Step into the future with us.
            </p>
            <Button
              variant="light"
              href="#contact-us"
